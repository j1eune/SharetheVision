...
.search-bar input {
	...
	padding: 0 35px;
	background-image:
		url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%23a1a4b9' stroke-width='3' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'%3e%3ccircle cx='11' cy='11' r='8'/%3e%3cpath d='M21 21l-4.35-4.35'/%3e%3c/svg%3e");
...
.mail-choice+label:before {
	...
	transition: 0.3s;
	background-image:
		url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='20' height='28' viewBox='0 0 24 24' fill='none' stroke='%23a1a4b9' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'%3e%3cpath d='M20 6L9 17l-5-5'/%3e%3c/svg%3e");
	background-repeat: no-repeat;
...
.mail-choice:checked+label:before {
	...
	background-image:
		url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='20' height='28' viewBox='0 0 24 24' fill='none' stroke='%23fff' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'%3e%3cpath d='M20 6L9 17l-5-5'/%3e%3c/svg%3e");
}
...
.mail-checklist .mail-choice+label:before {
	...
	margin-right: 12px;
	background-image:
		url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='14' height='18' viewBox='0 0 24 24' fill='none' stroke='%23fff' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'%3e%3cpath d='M20 6L9 17l-5-5'/%3e%3c/svg%3e");
}
...
.toggle-page:before, .toggle-page:after, .toggle-page span {
	position: absolute;
	top: 4px;
	width: 100px;
	height: 10px;
...
@media screen and (max-width: 370px) {
	.mail-doc-icons, .mail-checklist-date {
		display: none;
	}
}
...
.date, .hr, .min, .sec, .colon, .date2, .hr2, .min2, .sec2, .colon2,
	.date3, .hr3, .min3, .sec3, .colon3, .date4, .hr4, .min4, .sec4,
	.colon4, .date5, .hr5, .min5, .sec5, .colon5 {
	color: var(- -text);
	text-shadow: 0 0 10px var(- -shadow-1), 0 0 15px var(- -shadow-2), 0 0
		20px var(- -shadow-2);
}

.hr, .min, .sec, .colon, .hr2, .min2, .sec2, .colon2, .hr3, .min3, .sec3,
	.colon3, .hr4, .min4, .sec4, .colon4, .hr5, .min5, .sec5, .colon5 {
	width: 20%;
	float: left;
	text-align: center;
	font-size: 2rem;
...
.controls5 textarea, .controls6 textarea, .controls7 textarea,
	.controls8 textarea {
	resize: none;
	height: 130px;
	width: 400px;
...
.file-upload, .file-upload-select, .file-upload2, .file-upload-selct2,
	.file-upload3, .file-upload-selct3, .file-upload4, .file-upload-selct4,
...
.file-upload .file-upload-select .file-select-button, .file-upload2 .file-upload-select2 .file-select-button2,
	.file-upload3 .file-upload-select3 .file-select-button3, .file-upload4 .file-upload-select4 .file-select-button4,
...
.file-upload .file-upload-select .file-select-name, .file-upload2 .file-upload-select2 .file-select-name2,
	.file-upload3 .file-upload-select3 .file-select-name3, .file-upload4 .file-upload-select4 .file-select-name4,
...
.file-upload .file-upload-select input[type="file"], .file-upload2 .file-upload-select2 input[type="file"],
	.file-upload3 .file-upload-select3 input[type="file"], .file-upload4 .file-upload-select4 input[type="file"],
...
.user-profile-area::-webkit-scrollbar-thumb, .inbox::-webkit-scrollbar-thumb,
								...
								<div class="user-profile-area">
									...
									<div class="side-wrapper">
											...
											<div class="profileBox">
												<c:if test="${userAttach != null}">
													<img class="profileImg"
														src="resources/muploadFile/${userAttach.atChange }" />
												</c:if>
												<c:if test="${userAttach == null }">
													<img class="profileImg"
														src="resources/assets/images/defaultProfile.png">
												</c:if>
											</div>
											<br>
											<!--결재 대쉬보드 프로필 시작-->
										...
										<div class="progress">
											<div class="progress-bar"
												style="width:${statusCompleteCount / statusTotalCount * 100}%"></div>
										</div>
									...
									<div class="side-wrapper">
										...
										<div class="approvalbuttonlist">
											<a class="button1" href="#" data-toggle="modal"
												data-target=".bs-example-modal-new">기안</a> <a
												class="button2" href="#" data-toggle="modal"
												data-target=".bs-example-modal-new2">세금</a> <a
												class="button3" href="#" data-toggle="modal"
												data-target=".bs-example-modal-new3">보고</a> <a
												class="button4" href="#" data-toggle="modal"
												data-target=".bs-example-modal-new4">품의</a> <a
												class="button5" href="#" data-toggle="modal"
												data-target=".bs-example-modal-new5">계획</a>
										</div>
														...
														<div class="body-message">
															<div class="tabs">
																<form id="apform1" method="post">
																	<!--결재폼 1 : 기안서 폼 시작 -->
																	<input type="radio" name="apvType" id="tabone" checked
																		value="기안서" /> <label for="tabone">기안서</label>
																	<div class="tab">
																		<!--결재 관련 이름 시작-->
																		<div id="apwstart">🔍기안자는&nbsp;</div>
																		<div id="apw1" name="apd1">${loginUser.deptName}팀&nbsp;</div>
																		<div id="apw2" name="apn1">${loginUser.name}&nbsp;</div>
																		<div id="apw3" name="apc1">${loginUser.jobName }&nbsp;</div>
																		<div>님&nbsp;입니다.</div>
																		<br>
																		...
																		<!--기안서 폼 합의자 선택 시작-->
																		<div class="agrselect">
																			<select name="apvAgr" class="selectpicker col-md-10"
																				multiple data-style="btn-primary" required>
																				<c:forEach items="${ aplist }" var="ap">
																					<c:if test="${ ap.name != loginUser.name}">
																						<optgroup label="${ ap.deptName } 팀 ">
																							<c:if
																								test="${ ap.deptName eq '인사'&& ap.jobNo>=3 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '마케팅'&& ap.jobNo>=3 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '생산'&& ap.jobNo>=3 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '영업'&& ap.jobNo>=3 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '회계'&& ap.jobNo>=3 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>
																						</optgroup>
																		...
																		<!--기안서 폼 참조자 선택 시작-->
																		<div class="refselect">
																			<select name="apvRef" class="selectpicker col-md-10"
																				multiple data-style="btn-primary" required>
																				<c:forEach items="${ aplist }" var="ap">
																					<c:if test="${ ap.name != loginUser.name}">
																						<optgroup label="${ ap.deptName } 팀 ">
																		...
																		<!--기안서 폼 결재자 선택 시작-->
																		<div class="apselect">
																			<select name="apvApp" class="selectpicker col-md-10"
																				data-style="btn-primary" required>
																				<c:forEach items="${ aplist }" var="ap">
																					<c:if test="${ ap.name != loginUser.name}">
																						<optgroup label="${ ap.deptName } 팀 ">
																							<c:if
																								test="${ ap.deptName eq '인사' && ap.jobNo>=4 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '마케팅' && ap.jobNo>=4  }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '생산' && ap.jobNo>=4 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '영업' && ap.jobNo>=4 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>

																							<c:if
																								test="${ ap.deptName eq '회계' && ap.jobNo>=4 }">
																								<option value="${ ap.mId }">${ ap.name }
																									${ ap.jobName }</option>
																							</c:if>
																						</optgroup>
																		...
																		<div class="apside">
																			...
																			<br>
																			<div id="aptitle" name="apt1">제목:</div>
																			<input class="form-styling" type="text" name="apt"
																				placeholder="결재 제목" required /> <br>
																		</div>
																		<br>
																		...
																		<div class="controls4">
																			<textarea name="comment" class="floatLabel"
																		...
																		<div class="file-upload">
																			<div class="file-upload-select">
																				...
																				<div class="file-select-name">결재 상신시 양식에 맞는 문서
																					필수 첨부</div>
																		...
																		<div class="modal-footer">
																			...
																			<button class="apwcancle" data-dismiss="modal"
										...
										<!-- 결재폼2 모달 시작 -->
										<div class="modal fade bs-example-modal-new2" tabindex="-1"
											role="dialog" aria-labelledby="myLargeModalLabel"
											aria-hidden="true">
														...
														<div class="body-message">
															<div class="tabs">
																<form id="apform2" method="post">
																	<!--결재폼2 : 세금 폼 시작 -->
																	<input type="radio" name="apvType" id="tabtwo" checked
																		value="세금 계산서" /> <label for="tabtwo">세금계산서</label>
																	<div class="tab">
																		<!--결재 관련 이름 시작-->
																		<!--로그인세션 부서,이름,직급 보낸 후 뿌려주기 -->
																		<div id="apwstart">🧾기안자는&nbsp;</div>
																		<div id="apw1" name="apd2">${loginUser.deptName}팀&nbsp;</div>
																		<div id="apw2" name="apn2">${loginUser.name}&nbsp;</div>
																		<div id="apw3" name="apc2">${loginUser.jobName }&nbsp;</div>
																		<div>님&nbsp;입니다.</div>
																		<br>
																		<div id="wlwjd">👨‍💻결재선 지정</div>
																		<br>
																		...
																		<div class="file-upload2">
																			<div class="file-upload-select2">
																				...
																				<div class="file-select-name2">결재 상신시 양식에 맞는
																					문서 필수 첨부</div>
																				<input type="file" name="file-upload-input2"
																		...
																		<div class="modal-footer">
																			...
																			<button type="text" class="apwcancle"
										...
										<!-- 결재폼3 모달 시작 -->
										<div class="modal fade bs-example-modal-new3" tabindex="-1"
											role="dialog" aria-labelledby="myLargeModalLabel"
											aria-hidden="true">
														...
														<div class="body-message">
															<div class="tabs">
																<form id="apform3" method="post">
																	<!-- 결재폼3: 보고서 폼 시작 -->
																	<input type="radio" name="apvType" id="tabthree"
																		checked value="보고서" /> <label for="tabthree">보고서</label>
																	<div class="tab">

																		<!--결재 관련 이름 시작-->
																		<div id="apwstart">📁기안자는&nbsp;</div>
																		<div id="apw1" name="apd3">${loginUser.deptName}팀&nbsp;</div>
																		<div id="apw2" name="apn3">${loginUser.name}&nbsp;</div>
																		<div id="apw3" name="apc3">${loginUser.jobName }&nbsp;</div>
																		<div>님&nbsp;입니다.</div>
																		<br>
																		<div id="wlwjd">👨‍🏫결재선 지정</div>
																		<br>
																		...
																		<div class="file-upload3">
																			<div class="file-upload-select3">
																				...
																				<div class="file-select-name3">결재 상신시 양식에 맞는
																					문서 필수 첨부</div>
																				<input type="file" name="file-upload-input3"
																					id="file-upload-input3">
																			</div>
																		</div>
																		<br>
																		<!--보고서 파일첨부 끝-->
										...
										<!-- 결재폼4 모달 시작 -->
										<div class="modal fade bs-example-modal-new4" tabindex="-1"
											role="dialog" aria-labelledby="myLargeModalLabel"
											aria-hidden="true">
											<div class="modal-dialog">
												<!-- 모달 창 시작 -->
														...
														<div class="body-message">
															<div class="tabs">
																<form id="apform4" method="post">
																	<!--결재폼4: 품의서 시작-->
																	<input type="radio" name="apvType" id="tabfour" checked
																		value="품의서" /> <label for="tabfour">품의서</label>
																	<div class="tab">
																		<!--결재 관련 이름 시작-->
																		<div id="apwstart">📦기안자는&nbsp;</div>
																		<div id="apw1" name="apd4">${loginUser.deptName}팀&nbsp;</div>
																		<div id="apw2" name="apn4">${loginUser.name}&nbsp;</div>
																		<div id="apw3" name="apc4">${loginUser.jobName }&nbsp;</div>
																		<div>님&nbsp;입니다.</div>
																		<br>
																		<div id="wlwjd">💵결재선 지정</div>
																		<br>
																		...
																		<div class="file-upload4">
																			<div class="file-upload-select4">
																				...
																				<div class="file-select-name4">결재 상신시 양식에 맞는
																					문서 필수 첨부</div>
																				<input type="file" name="file-upload-input4"
																					id="file-upload-input4">
																			</div>
																		</div>
																		<br>
																		<!--품의서 파일첨부 끝-->
										...
										<!-- 결재폼5 모달 시작 -->
										<div class="modal fade bs-example-modal-new5" tabindex="-1"
											role="dialog" aria-labelledby="myLargeModalLabel"
											aria-hidden="true">
											<div class="modal-dialog">
												<!-- 모달 창 시작 -->
														...
														<div class="body-message">
															<div class="tabs">
																<form id="apform5" method="post">
																	<!--결재폼5: 계획서 시작-->
																	<input type="radio" name="apvType" id="tabfive" checked
																		value="계획서" /> <label for="tabfive">계획서</label>
																	<div class="tab">
																		<!--결재 관련 이름 시작-->
																		<div id="apwstart">🧾기안자는&nbsp;</div>
																		<div id="apw1" name="apd5">${loginUser.deptName}팀&nbsp;</div>
																		<div id="apw2" name="apn5">${loginUser.name}&nbsp;</div>
																		<div id="apw3" name="apc5">${loginUser.jobName }&nbsp;</div>
																		<div>님&nbsp;입니다.</div>
																		<br>
																		...
																		<div class="file-upload5">
																			<div class="file-upload-select5">
																				...
																				<div class="file-select-name5">결재 상신시 양식에 맞는
																					문서 필수 첨부</div>
																				<input type="file" name="file-upload-input5"
																					id="file-upload-input5">
																			</div>
																		</div>
																		<br>
																		<!--계획서 파일첨부 끝-->
								...
								<div class="main-area">
									...
									<div class="main-container">
										<div class="inbox-container">
											<div class="inbox">
												<div class="msg msg-department anim-y">결재 리스트</div>
												...
												<c:forEach items="${list}" var="apv" varStatus="vs">
													<div class="msg selected-bg anim-y">
														...
														<c:if test="${apv.apvStatus == 'A'}">
															<input type="checkbox" name="msg" id="mail1"
																class="mail-choice" checked>
														</c:if>
														<c:if test="${apv.apvStatus == 'B'}">
															<input type="checkbox" name="msg" id="mail1"
																class="mail-choice3" checked>
														</c:if>
														<c:if test="${apv.apvStatus == 'C'}">
															<input type="checkbox" name="msg" id="mail1"
																class="mail-choice4" checked>
														</c:if>
														<c:if test="${apv.apvStatus == 'D'}">
															<input type="checkbox" name="msg" id="mail1"
																class="mail-choice2" checked>
														</c:if>
														...
														<div class="msg-content" style="width: 300px;">
															...
															<div class="msg-sender2">&nbsp;${apv.mName}</div>
															<br>
															<!-- 														<div class="msg-sender3">&nbsp;사원</div> -->
															<!--결재 목록 결재권자-->
															<div class="msg-approve">결재권자:</div>
															<div class="msg-approve2">&nbsp;${apv.apvApp}</div>
															<br>
															<!-- 														<div class="msg-approve3">&nbsp;사장</div> -->
															<!--결재 목록 문서종류-->
															<div class="msg-doctype">문서종류:</div>
															<div class="msg-doctype2">&nbsp;${apv.apvType}</div>
															<br>
														</div>
														<c:if test="${apv.atChange != null}">
															<img src="resources/muploadFile/${apv.atChange}"
										...
										<div class="mail-detail">
											<div class="mail-detail-header">
												...
												<div class="mail-detail-name" id="detailHead"></div>
												<div class="mail-icons">
													<input type="hidden" id="approvalApvNo" />
													<button class="button button--primary approvalBtn"
														value="alert" id="apv_approve" data-status="ACCEPT">승인</button>
													<button class="button button--secondary approvalBtn"
														value="alert" id="apv_refuse" data-status="REFUSE">거절</button>
													<button class="button button--cancel approvalBtn"
														value="alert" id="apv_cancle" data-status="CANCEL">반려</button>
												</div>
											</div>
											<script>
											...
											<div class="mail-contents">
												<div class="mail-contents-subject">
													<input type="checkbox" name="msg" id="mail20"
														class="mail-choice" checked> <label for="mail20"></label>
													<div class="mail-contents-title" id="detailTitle"></div>
												</div>
												<div class="wrapper">

													<div class="mail">
														<div class="mail-time" id="detailTime"></div>


														<div class="assignee">
															<div class="aprf1" id="detailReferrer">참조자:</div>
															<div></div>
															<div class="af" id="detailAgreeer">합의자:</div>
															<div></div>
															<div class="af" id="detailApprover">결재권자:</div>
															<div></div>
														</div>
														...
														<div class="mail-assign" id="detailStatus">
															...
															<c:forEach var="accept" items="${acceptList }">
																...
																<c:set var="className"
																	value="${accept.acceptType eq 'ACCEPT' ? 'apv' : accept.acceptType eq 'REFUSE' ? 'cancle' : 'return' }" />
																<c:set var="dateClass"
																	value="${accept.acceptType eq 'ACCEPT' ? 'assign' : accept.acceptType eq 'REFUSE' ? 'cancle' : 'return' }" />
																<c:set var="text"
																	value="${accept.acceptType eq 'ACCEPT' ? '승인' : accept.acceptType eq 'REFUSE' ? '거절' : '반려' }" />
																<div class="assignee">
																	<div class="msg-${className }name">&nbsp;${accept.memNm }</div>
																	<div class="msg-${className }class">&nbsp;${accept.jobName }</div>
																	<div class="msg-${className }msg">&nbsp;${text }
																		되었습니다.</div>
